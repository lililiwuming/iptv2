...
function 头部导航(){
    ...
    for(var j=0;j<列表.length;j++){
        ...
        if(类型.indexOf("vod")!=-1){
            ...
            var str="类型+喜剧+爱情+恐怖+动作+科幻+剧情+战争+警匪+犯罪+动画+奇幻+武侠+冒险+枪战+恐怖+悬疑+惊悚+经典+青春+文艺+微电影+古装+历史+运动+农村+惊悚+惊悚+伦理+情色+福利+三级+儿童+网络电影\n地区+大陆+香港+台湾+美国+英国+法国+日本+韩国+德国+泰国+印度+西班牙+加拿大+其他\n年份++2022+2021+2020+2019+2018+2017+2016+2015+2014+2013+2012+2011+2010+2009+2008+2007+2006+2005+2004+2003+2002+2001+2000\n排序+按时间=time+按人气=hits+按评分=score";
        }else{
            var str="";
        }
        if(类型.indexOf("接口")!=-1){
